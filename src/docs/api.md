...
# [Backend](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/backend.js#L7)


 Provides methods for the backend process management

## [`open(opts)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/backend.js#L14)
...
## [`close()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/backend.js#L22)
...
## [`sendToProcess()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/backend.js#L29)
...
# [Bluetooth](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/bluetooth.js#L7)


 A high level, cross-platform API for Bluetooth Pub-Sub

## [`Bluetooth` (extends `EventEmitter`)](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/bluetooth.js#L13)

Create an instance of a Bluetooth service.

### [`constructor(serviceId)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/bluetooth.js#L21)
...
### [`start()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/bluetooth.js#L58)
...
### [`subscribe(id )`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/bluetooth.js#L78)
...
### [`publish(id, value)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/bluetooth.js#L91)
...
### [`undefined(buf, hashAlgorithm)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/bootstrap.js#L25)
...
## [`checkHash(dest, hash, hashAlgorithm)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/bootstrap.js#L36)
...
### [`write(options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/bootstrap.js#L74)
...
### [`download(url)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/bootstrap.js#L104)
...
## [`bootstrap()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/bootstrap.js#L131)

This is a `FunctionDeclaration` named `bootstrap` in `node_modules/@socketsupply/socket-api/bootstrap.js`, it's exported but undocumented.


# [Buffer](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/buffer.js#L14)
...
### [Buffer](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/buffer.js#L296)
...
### [undefined](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/buffer.js#L296)
...
### [undefined](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/buffer.js#L355)
...
### [Buffer](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/buffer.js#L430)
...
### [undefined](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/buffer.js#L430)
...
### [Buffer](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/buffer.js#L467)

Creates a new filled Buffer instance.
 alloc(size[, fill[, encoding]])

### [undefined](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/buffer.js#L467)
...
### [Buffer](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/buffer.js#L479)

Equivalent to Buffer(num), by default creates a non-zero-filled Buffer instance.

### [undefined](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/buffer.js#L479)
...
### [Buffer](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/buffer.js#L485)

Equivalent to SlowBuffer(num), by default creates a non-zero-filled Buffer instance.

### [undefined](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/buffer.js#L485)
...
# [Crypto](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/crypto.js#L8)


 Some high level methods around the `crypto.subtle` api for getting
 random bytes and hashing.

## [webcrypto](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/crypto.js#L15)

WebCrypto API

## [`getRandomValues(buffer)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/crypto.js#L23)
...
## [RANDOM_BYTES_QUOTA](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/crypto.js#L35)

Maximum total size of random bytes per page

## [MAX_RANDOM_BYTES](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/crypto.js#L40)

Maximum total size for random bytes.

## [MAX_RANDOM_BYTES_PAGES](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/crypto.js#L45)

Maximum total amount of allocated per page of bytes (max/quota)

## [`randomBytes(size)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/crypto.js#L53)
...
## [`createDigest(algorithm, message)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/crypto.js#L80)
...
# [Dgram](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L8)


 This module provides an implementation of UDP datagram sockets. It does
 not (yet) provide any of the multicast methods or properties.

## [`ERR_SOCKET_ALREADY_BOUND` (extends `SocketError`)](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L41)

Thrown when a socket is already bound.

## [`ERR_SOCKET_DGRAM_IS_CONNECTED` (extends `SocketError`)](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L58)

Thrown when the socket is already connected.

## [`ERR_SOCKET_DGRAM_NOT_CONNECTED` (extends `SocketError`)](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L65)

Thrown when the socket is not connected.

## [`ERR_SOCKET_DGRAM_NOT_RUNNING` (extends `SocketError`)](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L73)

Thrown when the socket is not running (not bound or connected).

## [`ERR_SOCKET_BAD_TYPE` (extends `TypeError`)](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L80)

Thrown when a bad socket type is used in an argument.

## [`ERR_SOCKET_BAD_PORT` (extends `RangeError`)](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L90)

Thrown when a bad port is given.

## [`createSocket(options, callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L629)
...
## [`Socket` (extends `EventEmitter`)](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L635)

New instances of dgram.Socket are created using dgram.createSocket().
 The new keyword is not to be used to create dgram.Socket instances.

### [`bind(port, address, callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L706)
...
### [`connect(port, host, connectListener)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L758)
...
### [`disconnect()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L791)
...
### [`send(msg, offset, length, port, address, callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L850)
...
### [`close(callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L926)
...
### [`address()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L984)
...
### [`remoteAddress()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L1019)
...
### [`setRecvBufferSize(size)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L1050)
...
### [`setSendBufferSize(size)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L1067)
...
### [`getRecvBufferSize()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L1080)

External docs: https://nodejs.org/api/dgram.html#socketgetrecvbuffersize



### [`getSendBufferSize()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dgram.js#L1088)
...
# [DNS](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dns/index.js#L13)
...
## [`lookup(hostname, opts, cb)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dns/index.js#L45)
...
# [DNS.promises](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dns/promises.js#L13)
...
## [`lookup(hostname, opts)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/dns/promises.js#L23)
...
# [File System](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L24)
...
## [`access(path, mode , callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L77)
...
## [`chmod(path, mode, callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L110)
...
## [`close(fd, callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L140)
...
## [`copyFile()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L156)

This is a `FunctionDeclaration` named `copyFile` in `node_modules/@socketsupply/socket-api/fs/index.js`, it's exported but undocumented.


## [`createReadStream(path, options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L165)
...
## [`createWriteStream(path, options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L205)
...
## [`fstat(fd, options, callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L249)
...
## [`open(path, flags , mode , callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L332)
...
## [`opendir(path, options, callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L385)
...
## [`read(fd, buffer, offset, length, position, callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L411)
...
## [`readdir(path, options, callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L445)
...
## [`readFile(path, options, callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L496)
...
## [`stat(path, options, callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L569)
...
## [`writeFile(path, data, options, callback)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L639)
...
## [`writev()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/index.js#L676)

This is a `FunctionDeclaration` named `writev` in `node_modules/@socketsupply/socket-api/fs/index.js`, it's exported but undocumented.


# [FS.promises](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/promises.js#L4)



## [`access(path, mode, options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/promises.js#L38)
...
## [`chmod(path, mode)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/promises.js#L55)
...
## [`mkdir(path, options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/promises.js#L124)
...
## [`open(path, flags, mode)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/promises.js#L148)
...
## [`opendir(path, options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/promises.js#L160)
...
## [`readdir(path, options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/promises.js#L172)
...
## [`readFile(path, options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/promises.js#L205)
...
## [`stat(path, options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/promises.js#L260)
...
## [`writeFile(path, data, options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/promises.js#L314)
...
# [FS.Stream](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L4)



## [DEFAULT_STREAM_HIGH_WATER_MARK](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L8)

This is a `VariableDeclaration` named `DEFAULT_STREAM_HIGH_WATER_MARK` in `node_modules/@socketsupply/socket-api/fs/stream.js`, it's exported but undocumented.


## [`ReadStream` (extends `Readable`)](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L13)

A `Readable` stream for a `FileHandle`.

### [`constructor()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L18)

`ReadStream` class constructor

### [`setHandle(handle)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L54)
...
### [`highWaterMark()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L61)

The max buffer size for the ReadStream.

### [`path()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L68)

Relative or absolute path of the underlying `FileHandle`.

### [`pending()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L75)

`true` if the stream is in a pending state.

### [`emit()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L83)

Handles `shouldEmitClose` setting from `options.emitClose` in constructor.

## [`WriteStream` (extends `Writable`)](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L164)

A `Writable` stream for a `FileHandle`.

### [`constructor()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L169)

`WriteStream` class constructor

### [`setHandle(handle)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L196)
...
### [`highWaterMark()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L203)

The max buffer size for the Writetream.

### [`path()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L210)

Relative or absolute path of the underlying `FileHandle`.

### [`pending()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L217)

`true` if the stream is in a pending state.

### [`emit()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L252)

Handles `shouldEmitClose` setting from `options.emitClose` in constructor.

## [FileReadStream](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L325)

This is a `VariableDeclaration` named `FileReadStream` in `node_modules/@socketsupply/socket-api/fs/stream.js`, it's exported but undocumented.


## [FileWriteStream](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/fs/stream.js#L326)

This is a `VariableDeclaration` named `FileWriteStream` in `node_modules/@socketsupply/socket-api/fs/stream.js`, it's exported but undocumented.


# [IPC](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L28)
...
## [`postMessage()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L48)

This is a `FunctionDeclaration` named `postMessage` in `node_modules/@socketsupply/socket-api/ipc.js`, it's exported but undocumented.


## [OK](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L319)

Represents an OK IPC status.

## [ERROR](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L324)

Represents an ERROR IPC status.

## [TIMEOUT](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L329)

Timeout in milliseconds for IPC requests.

## [kDebugEnabled](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L334)

Symbol for the `ipc.debug.enabled` property

## [`parseSeq(seq, options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L342)
...
## [`debug(enable)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L352)
...
## [`Message` (extends `URL`)](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L384)

A container for a IPC message based on a `ipc://` URI scheme.

### [`PROTOCOL()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L388)

The expected protocol for an IPC message.

### [`from(input, params)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L398)
...
### [`isValidInput(input)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L451)
...
### [`constructor(input)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L466)
...
### [`command()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L492)

Computed IPC message name.

### [`name()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L500)

Computed IPC message name.

### [`id()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L507)

Computed `id` value for the command.

### [`seq()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L514)

Computed `seq` (sequence) value for the command.

### [`value()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L522)

Computed message value potentially given in message parameters.
 This value is automatically decoded, but not treated as JSON.

### [`index()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L531)

Computed `index` value for the command potentially referring to
 the window index the command is scoped to or originating from. If not
 specified in the message parameters, then this value defaults to `-1`.

### [`json()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L548)

Computed value parsed as JSON. This value is `null` if the value is not present
 or it is invalid JSON.

### [`params()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L555)

Computed readonly object of message parameters.

### [`entries()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L563)
...
### [`set(key, value)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L574)
...
### [`get(key, defaultValue)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L588)
...
### [`delete(key)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L608)
...
### [`keys()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L620)
...
### [`values()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L628)
...
### [`has(key)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L637)
...
### [`toJSON()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L644)

Converts a `Message` instance into a plain JSON object.

## [Result](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L656)
...
### [`from(result, maybeError, maybeSource)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L665)
...
### [`constructor(err , data , source )`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L703)
...
### [`length()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L732)

Computed result length.

## [`ready()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L751)

Waits for the native IPC layer to be ready and exposed on the
 global window object.

## [`sendSync(command, params)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L776)
...
## [`emit(name, value, target , options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L821)
...
## [`resolve(seq, value)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L857)
...
## [`send(command, value)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L876)
...
## [`write(command, params, buffer, options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L927)
...
## [`request(command, params, options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L1024)
...
## [`createBinding(domain, ctx)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/ipc.js#L1117)
...
# [OS](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/os.js#L8)


 This module provides normalized system information from all the major
 operating systems.

## [`arch()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/os.js#L20)

This is a `FunctionDeclaration` named `arch` in `node_modules/@socketsupply/socket-api/os.js`, it's exported but undocumented.


## [`networkInterfaces()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/os.js#L53)

This is a `FunctionDeclaration` named `networkInterfaces` in `node_modules/@socketsupply/socket-api/os.js`, it's exported but undocumented.


## [`platform()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/os.js#L141)

This is a `FunctionDeclaration` named `platform` in `node_modules/@socketsupply/socket-api/os.js`, it's exported but undocumented.


## [`type()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/os.js#L170)

This is a `FunctionDeclaration` named `type` in `node_modules/@socketsupply/socket-api/os.js`, it's exported but undocumented.


## [`isWindows()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/os.js#L210)

This is a `FunctionDeclaration` named `isWindows` in `node_modules/@socketsupply/socket-api/os.js`, it's exported but undocumented.


## [`tmpdir()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/os.js#L219)

This is a `FunctionDeclaration` named `tmpdir` in `node_modules/@socketsupply/socket-api/os.js`, it's exported but undocumented.


## [EOL](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/os.js#L263)

This is a `VariableDeclaration` named `EOL` in `node_modules/@socketsupply/socket-api/os.js`, it's exported but undocumented.


# [Path](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/path/path.js#L4)



## [Path](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/path/path.js#L9)

This is a `ClassDeclaration` named `Path` in `node_modules/@socketsupply/socket-api/path/path.js`, it's exported but undocumented.


### [`cwd(opts)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/path/path.js#L16)
...
### [`constructor(opts)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/path/path.js#L45)
...
### [`resolve()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/path/path.js#L61)



### [`normalize()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/path/path.js#L67)



# [Process](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/process.js#L4)



## [`homedir()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/process.js#L31)
...
## [`exit(code)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/process.js#L38)
...
# [Runtime](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L8)


 Provides runtime-specific methods

## [currentWindow](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L12)

This is a `VariableDeclaration` named `currentWindow` in `node_modules/@socketsupply/socket-api/runtime.js`, it's exported but undocumented.


## [debug](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L14)

This is a `VariableDeclaration` named `debug` in `node_modules/@socketsupply/socket-api/runtime.js`, it's exported but undocumented.


## [config](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L16)

This is a `VariableDeclaration` named `config` in `node_modules/@socketsupply/socket-api/runtime.js`, it's exported but undocumented.


## [`send()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L26)

This is a `FunctionDeclaration` named `send` in `node_modules/@socketsupply/socket-api/runtime.js`, it's exported but undocumented.


## [`getWindows()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L42)

This is a `FunctionDeclaration` named `getWindows` in `node_modules/@socketsupply/socket-api/runtime.js`, it's exported but undocumented.


## [`openExternal()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L46)

This is a `FunctionDeclaration` named `openExternal` in `node_modules/@socketsupply/socket-api/runtime.js`, it's exported but undocumented.


## [`exit(options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L55)
...
## [`setTitle(options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L64)
...
## [`inspect()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L68)

This is a `FunctionDeclaration` named `inspect` in `node_modules/@socketsupply/socket-api/runtime.js`, it's exported but undocumented.


## [`show(opts)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L78)
...
## [`hide(opts)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L91)
...
## [`navigate(opts)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L102)
...
## [`setWindowBackgroundColor()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L111)

This is a `FunctionDeclaration` named `setWindowBackgroundColor` in `node_modules/@socketsupply/socket-api/runtime.js`, it's exported but undocumented.


## [`setContextMenu(options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L122)
...
## [`setSystemMenuItemEnabled()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L130)

This is a `FunctionDeclaration` named `setSystemMenuItemEnabled` in `node_modules/@socketsupply/socket-api/runtime.js`, it's exported but undocumented.


## [`setSystemMenu(options)`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L219)
...
## [`reload()`](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/runtime.js#L268)

This is a `FunctionDeclaration` named `reload` in `node_modules/@socketsupply/socket-api/runtime.js`, it's exported but undocumented.


# [Stream](https://github.com/socketsupply/socket-api/blob/master/node_modules/@socketsupply/socket-api/stream.js#L5)
